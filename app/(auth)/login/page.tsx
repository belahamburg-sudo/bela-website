    ...
    <div className="min-h-screen bg-obsidian">
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0" aria-hidden>
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(232,192,64,0.13),transparent_55%)]" />
          ...
          <div className="absolute inset-0 opacity-[0.035] [background-image:linear-gradient(rgba(232,192,64,1)_1px,transparent_1px),linear-gradient(90deg,rgba(232,192,64,1)_1px,transparent_1px)] [background-size:60px_60px]" />
        </div>
