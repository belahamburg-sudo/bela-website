...
/**
 * Error boundary for the member area (/db). Catches any error thrown while
 * rendering a dashboard page and shows a graceful, branded fallback with a
 * retry instead of the raw white "Application error" screen.
 */
