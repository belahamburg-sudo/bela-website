      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-obsidian px-4 py-16 sm:px-6">
        ...
        <div className="relative z-10 w-full max-w-3xl">
          ...
          <form onSubmit={handleSubmit} className="relative overflow-hidden rounded-[2rem] border border-gold-300/14 bg-[#120e08]/90 p-6 shadow-[0_24px_100px_rgba(0,0,0,0.42)] backdrop-blur-xl sm:p-8 lg:p-10">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(201, 169, 97,0.08),transparent_40%)]" aria-hidden />

            <div className="relative z-10">
              {step === 1 && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="mb-8 flex justify-center">
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-gold-300/20 bg-gold-gradient/10 shadow-[0_0_30px_rgba(201, 169, 97,0.15)]">
                    ...
                    {GOALS.map((item) => (
                      <button
                        ...
                        className={`rounded-2xl border p-5 text-left transition-all ${
                          goal === item
                            ? "border-gold-300 bg-gold-gradient/10 shadow-[0_0_20px_rgba(201, 169, 97,0.1)]"
                      ...
                      return (
                        <button
                          ...
                          className={`relative flex flex-col items-center rounded-3xl border p-6 text-center transition-all ${
                            isSelected
                              ? "z-10 scale-[1.02] border-gold-300 bg-gold-gradient/[0.08] shadow-[0_20px_50px_rgba(201, 169, 97,0.2)]"
