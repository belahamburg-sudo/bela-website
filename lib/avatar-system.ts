...
export const MEMBER_AVATARS: MemberAvatar[] = [
  { id: "miner-01", name: "Starter Miner", badge: "SM", accent: "from-gold-200 to-gold-600", unlockPoints: 0 },
  { id: "miner-02", name: "Night Digger", badge: "ND", accent: "from-gold-300 to-gold-700", unlockPoints: 40 },
  { id: "miner-03", name: "Prompt Scout", badge: "PS", accent: "from-gold-100 to-gold-600", unlockPoints: 80 },
  { id: "miner-04", name: "Signal Hunter", badge: "SH", accent: "from-gold-400 to-gold-800", unlockPoints: 120 },
  { id: "miner-05", name: "Cave Runner", badge: "CR", accent: "from-gold-200 to-gold-700", unlockPoints: 180 },
  { id: "miner-06", name: "Gold Mapper", badge: "GM", accent: "from-gold-100 to-gold-600", unlockPoints: 240 },
  { id: "miner-07", name: "Market Prospector", badge: "MP", accent: "from-gold-300 to-gold-800", unlockPoints: 320 },
  { id: "miner-08", name: "Offer Crafter", badge: "OC", accent: "from-gold-50 to-gold-600", unlockPoints: 420 },
  { id: "miner-09", name: "Launch Builder", badge: "LB", accent: "from-gold-200 to-gold-700", unlockPoints: 520 },
  { id: "miner-10", name: "Automation Smith", badge: "AS", accent: "from-gold-100 to-gold-800", unlockPoints: 640 },
  { id: "miner-11", name: "Revenue Tracker", badge: "RT", accent: "from-gold-300 to-gold-700", unlockPoints: 760 },
  { id: "miner-12", name: "Funnel Captain", badge: "FC", accent: "from-gold-200 to-gold-800", unlockPoints: 900 },
  { id: "miner-13", name: "Creator Chief", badge: "CC", accent: "from-gold-100 to-gold-700", unlockPoints: 1040 },
  { id: "miner-14", name: "Cashflow Ranger", badge: "CR", accent: "from-gold-400 to-gold-900", unlockPoints: 1200 },
  { id: "miner-15", name: "System Pilot", badge: "SP", accent: "from-gold-50 to-gold-700", unlockPoints: 1360 },
  { id: "miner-16", name: "AI Merchant", badge: "AM", accent: "from-gold-300 to-gold-800", unlockPoints: 1520 },
  { id: "miner-17", name: "Scale Explorer", badge: "SE", accent: "from-gold-100 to-gold-600", unlockPoints: 1700 },
  { id: "miner-18", name: "Vault Architect", badge: "VA", accent: "from-gold-50 to-gold-800", unlockPoints: 1880 },
  { id: "miner-19", name: "Empire Miner", badge: "EM", accent: "from-gold-200 to-gold-900", unlockPoints: 2060 },
  { id: "miner-20", name: "Goldmaster", badge: "GM", accent: "from-gold-50 via-gold-200 to-gold-600", unlockPoints: 2240 },
];
