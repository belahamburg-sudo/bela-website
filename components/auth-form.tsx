  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4">
      ...
      <button
        ...
        className="btn-shimmer relative mt-2 flex w-full items-center justify-center gap-2.5 bg-gradient-to-b from-gold-200 to-gold-400 px-6 py-4 text-[11px] font-bold uppercase tracking-[0.22em] text-obsidian shadow-[0_8px_30px_-8px_rgba(140,90,20,0.7)] transition-all hover:from-gold-100 hover:to-gold-300 disabled:cursor-not-allowed disabled:opacity-50 active:scale-[0.98]"
      >
        {status === "loading" ? (
