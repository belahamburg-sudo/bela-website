...
export function MemberAvatar({ avatarId, points = 0, size = "md", hidePoints = false }: Props) {
  ...
  return (
    <div className="relative inline-flex flex-col items-center gap-2">
      <div
        className={`relative flex items-center justify-center overflow-hidden rounded-[24px] border border-gold-300/20 bg-gradient-to-br ${avatar.accent} ${sizeClasses[size]} shadow-[0_18px_50px_rgba(201, 169, 97,0.18)]`}
      >
        <Image 
          src={avatarUrl} 
          alt={avatar.name} 
