    ...
    <section className="relative py-20 lg:py-28 sec-raised overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <div ref={headingRef} style={{ opacity: 0 }}>
          <p className="eyebrow mb-6 mx-auto"><span className="h-1.5 w-1.5 shrink-0 rotate-45 bg-gold-300 shadow-[0_0_6px_rgba(201, 169, 97,0.55)]" aria-hidden />Das System</p>
        ...
        <div ref={contentRef} style={{ opacity: 0 }}>
          {/* Animated search bar */}
          <div className="mx-auto max-w-lg mb-8 lg:mb-12 rounded-sm border border-gold-300/20 bg-white/[0.03] backdrop-blur-sm overflow-hidden shadow-[0_0_0_1px_rgba(201, 169, 97,0.03)]">
