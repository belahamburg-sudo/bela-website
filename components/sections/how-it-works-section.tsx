    ...
    <section className="relative py-20 lg:py-40 bg-obsidian overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <div ref={contentRef} style={{ opacity: 0 }}>
          {/* Animated search bar */}
          <div className="mx-auto max-w-lg mb-8 lg:mb-12 rounded-sm border border-gold-300/20 bg-white/[0.03] backdrop-blur-sm overflow-hidden shadow-[0_0_0_1px_rgba(200,146,42,0.03)]">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              href="/webinar"
              className="btn-shimmer inline-flex items-center gap-2 rounded-full bg-gold-gradient px-8 py-3.5 text-sm font-bold uppercase tracking-[0.14em] text-obsidian transition-all hover:bg-gold-200 hover:shadow-[0_0_40px_rgba(200,146,42,0.5)]"
            >
              Webinar starten →
            </Link>
            <Link
