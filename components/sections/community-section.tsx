    ...
    <section className="relative py-20 lg:py-28 bg-obsidian overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div ref={headingRef} className="mb-10 lg:mb-16 text-center" style={{ opacity: 0 }}>
          <p className="eyebrow mb-6 mx-auto"><span className="h-1.5 w-1.5 shrink-0 rotate-45 bg-gold-300 shadow-[0_0_6px_rgba(201, 169, 97,0.55)]" aria-hidden />Community</p>
