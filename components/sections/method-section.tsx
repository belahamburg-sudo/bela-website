    ...
    <section className="relative py-16 lg:py-40 bg-obsidian overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          ...
          >
            {/* Slope fill */}
            <polygon points="0,510 1200,130 1200,540 0,540" fill="rgba(212,175,55,0.018)" />
            {/* Slope edge */}
            <line x1="0" y1="510" x2="1200" y2="130" stroke="rgba(212,175,55,0.07)" strokeWidth="1.5" />
            ...
            />
            {/* Trail markers */}
            <circle cx="150" cy="375" r="5" fill="rgba(212,175,55,0.4)" />
            <circle cx="450" cy="305" r="5" fill="rgba(212,175,55,0.4)" />
            <circle cx="750" cy="235" r="5" fill="rgba(212,175,55,0.4)" />
            <circle cx="1050" cy="165" r="7" fill="rgba(212,175,55,0.7)" />
          </svg>
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{
                ...
                width: "2px",
                backgroundImage:
                  "repeating-linear-gradient(to bottom, rgba(212,175,55,0.3) 0px, rgba(212,175,55,0.3) 6px, transparent 6px, transparent 12px)",
              }}
            />
