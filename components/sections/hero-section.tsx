        ...
        <div className="grid lg:grid-cols-2 gap-12 items-end">
          ...
          <div>
            ...
            >
              <Link
                href="/webinar"
                className="btn-shimmer inline-flex items-center gap-2 rounded-sm bg-gold-gradient px-8 py-3.5 text-sm font-bold uppercase tracking-[0.12em] text-obsidian transition-all hover:bg-gold-200 hover:shadow-[0_0_40px_rgba(200,146,42,0.5)]"
              >
                Gratis Webinar →
              </Link>
              <Link
